...
if (window.File && window.FileList && window.FileReader) {
    ...
    live('button.copy-button', 'click', function(e) { copyTextToClipboard(this.parentNode.childNodes[0].innerHTML) });
